...
public class Polymorphism {
    ...
    */
    static class MySQLDatabase extends Database {
        ...
        // Constructor calling the parent class constructor
        public MySQLDatabase(String startConnectionString, String startUsername, String startPassword) {
            super(startConnectionString, startUsername, startPassword);
        }
    ...
    */
        public static void main(String[] args) {
            ...
            Database mysqlDB = new MySQLDatabase("mysqlConnectionString", "mysqlUser", "mysqlPass");
